...
<body>
  <div class="form-registration">
    <form:form
      action="${pageContext.request.contextPath}/addTodayPatient"
      method="POST" id="form" modelAttribute="patientInfoForm">
      ...
      <br>
      <div class="center-f">
        <input type="submit" class="btn sub" value="Confirm"> <input
          type="button" class="btn sub reset-btn" value="Reset"
          data-clear=1> <input type="submit" name="back"
