...
public class BookingController {
	...
	public String backDoctorRegistration(@ModelAttribute("bookingForm") BookingForm bookingForm) {
		if (bookingForm.getBookingId() == null || bookingForm.getBookingId() == 0)
	...
	public ModelAndView backDoctorConfirm(@ModelAttribute("bookingForm") BookingForm form) {
		mv = new ModelAndView("booking");
