...
public class PatientMedicalRecordController {
    ...
    public ModelAndView uploadMedicalRecord(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            if (!msg.equalsIgnoreCase("File Upload Successful")) {
                ...
                mv.addObject("msg", "Cannot upload file : Please check Excel File." + msg);
            } else {
    ...
    public ModelAndView backDoctorConfirm(@ModelAttribute("patientMedicalRecordForm") PatientMedicalRecordForm form) {
        mv = new ModelAndView("patientMedicalRecord");
